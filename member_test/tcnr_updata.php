			...
			$(function(){
				...
				$("#btn_update").bind("click",function(){
					...
					if(flag_username&&flag_password&&flag_password_check){
							$.ajax({
								type: "POST",
								url: "http://192.168.60.101/member_test/memberAPI/tcnr_updata_api.php",
								data:{username:$("#username").val(),password:$("#password").val(),email:$("#email").val(),id:<?php echo $ID ?>},
								success: show,
								error:function(){
									alert("連接資料庫失敗");
								}
