...
<html lang="en">
  ...
  <body>
  	...
  	<div class="container text-center">
    	...
    	<div>
    		<a href="memberAPI/tcnr_member_api.php?query_type=logout" data-ajax="false" class="btn btn-primary" id="logout">登出</a>
    	</div>
  	</div>
	...
	<script>
		...
		function check(event){
			if(confirm("確定要刪除嗎?")){
				location.href = "memberAPI/tcnr_delete_api.php?query_type=delete&id="+event.data.id;
			}
		}
