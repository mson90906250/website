			    	...
			    	<tbody id="mTbody">
			    		<!--<?php while ($output = $result->fetch_assoc()) : ?>
				    		<tr>
				    			...
				    			<td>
				    				<a href="#" class="btn btn-primary mr5">更新</a>
	...
	<script>
		...
		function showData(data){
			...
			for(var i=0 ; i<data.length ; i++){
				$("#mTbody").append("<tr><td>"+data[i].id+"</td><td>"+data[i].username+"</td><td>"+data[i].password+"</td><td>"+data[i].bday+"</td><td>"+data[i].sex+"</td><td>"+data[i].create_time+"</td><td><a href='#' class='btn btn-primary mr5'>更新</a><a href='#' class='btn btn-danger'>刪除</a></td></tr>");
			}
		}*/
	</script>
